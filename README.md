...
| `overlayOff()` | `Future<bool>` | Disable any active overlay mode and re-enable screenshots, like that mode's toggle-off (idempotent; pure no-op when no overlay is active) |
